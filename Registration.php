...
<fieldset>
   ...
   First Name:  <input type="text" id="kraken" name="name" ><br>

    Last Name:  <input type="text" id="kraken" name="lname" ><br>

    Father's Name:  <input type="text" id="kraken" name="fname" ><br>

    Mother's  Name:  <input type="text" id="kraken" name="mname" ><br>
  ...
  <select>
    ...
    <option>B Negative</option>ccccc
...
<span>Don't have an account??</span><a href="Login.php">Log in</a>
